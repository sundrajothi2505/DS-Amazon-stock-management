-- Stock Manager database schema (PostgreSQL / Supabase version)
-- Mirrors schema.sql (SQLite) exactly in structure and meaning — only the
-- syntax needed to differs (SERIAL ids, CURRENT_TIMESTAMP defaults).
